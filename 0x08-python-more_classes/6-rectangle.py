...
class Rectangle:
    ...
    def width(self):
        """
            gets a function for private attribute width.
    ...
    def width(self, value):
        """
            sets function for private attribute width.
            Args:
    ...
    def height(self):
        """
            gets function for private attribute height.
    ...
    def height(self, value):
        """
            sets function for private attribute height.
            Args:
                value(int) new width value.
            Raises:
                TypeError: if value is not int.
